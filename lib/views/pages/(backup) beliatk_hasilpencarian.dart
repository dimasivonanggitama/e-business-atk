...
class beliatk_hasilpencarianPageOld extends StatefulWidget {
  const beliatk_hasilpencarianPageOld({Key? key}) : super(key: key);

  @override
  State<beliatk_hasilpencarianPageOld> createState() => _beliatk_hasilpencarianPageOld();
}

class _beliatk_hasilpencarianPageOld extends State<beliatk_hasilpencarianPageOld> with TickerProviderStateMixin {
